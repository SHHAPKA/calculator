...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(320, 470))
        icon = QIcon()
        icon.addFile(u":/icons/image/calculate.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border: none;")
        ...
        self.layout_buttons.addWidget(self.btn_add, 3, 4, 1, 1)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/image/backspace.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_backspace.setIcon(icon1)
        self.btn_backspace.setIconSize(QSize(30, 30))
